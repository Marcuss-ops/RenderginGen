...
func fullWireArtifact() client.Artifact {
	return client.Artifact{
		...
		ChrononTelemetry:         json.RawMessage(`{"schema":"chronon3d.render-telemetry-summary.v1","job":{"process_wall_ms":12.5}}`),
		ChrononTimingStorageKey:  "sha-raw-timing",
		ChrononTimingURL:         "https://store/objects/sha-raw-timing",
		ChrononTimingSHA256:      "sha-raw-timing",
		ChrononTimingSizeBytes:   2048,
		ChrononTimingContentType: "application/vnd.chronon.timing+json",
		DriveFileID:              "drive-1",
