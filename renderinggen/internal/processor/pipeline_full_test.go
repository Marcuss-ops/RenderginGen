...
func TestProcessExecutesSemanticOverlayPlan(t *testing.T) {
	...
	job := &queue.Job{
		...
		RenderPlan: json.RawMessage(`{
          ...
          "items":[
            {"id":"phrase-1","template_id":"IMPORTANT_PHRASE","preset_id":"phrase_default","text":"Hello world","start_ms":0,"end_ms":1000},
...
func TestProcessRecordsArtifactLedger(t *testing.T) {
	...
	job := &queue.Job{
		...
		RenderPlan: json.RawMessage(`{
          ...
          "items":[
            {"id":"phrase-1","template_id":"IMPORTANT_PHRASE","preset_id":"phrase_default","text":"Hello world","start_ms":0,"end_ms":1000},
            {"id":"word-1","template_id":"IMPORTANT_WORD","preset_id":"phrase_default","text":"APPLE","start_ms":1000,"end_ms":2000},
	...
	if rec.PresetID != "phrase_default" {
		t.Fatalf("preset_id = %q, want phrase_default (canonical text preset)", rec.PresetID)
	}
