...
//	+ "DONALD TRUMP" (IMPORTANT_PHRASE, caption_card, f20-60)
...
//	DejaVuSans.ttf               690243adfefe0ce154b547db6205794bd30ac4277275179517a90994f4980648
//
// This document must stay byte-identical to
// RenderingGen/testdata/golden/golden-semantic-overlay-job-v1.json, which is
// the payload the golden canary (infra/e2e/run-golden-overlay.sh) actually
// submits. It is the golden reference for the semantic path: if the compiler,
// the preset vocabulary or the asset pipeline changes, this job must keep
// compiling and rendering. Do not edit it casually — regenerate deliberately
// and update BOTH copies together.
