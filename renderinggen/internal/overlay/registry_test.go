...
func TestCompileSemanticRejectsKindTemplateMismatch(t *testing.T) {
	raw := []byte(`{"schema_version":"renderinggen.overlay-plan.v1","plan_id":"p","video_id":"v","width":1280,"height":720,"fps_num":30,"fps_den":1,
      "items":[{"id":"x","kind":"important_phrase","template_id":"PERSON","preset_id":"phrase_default","text":"Ada","start_ms":0,"end_ms":1000}]}`)
...
func TestCompileSemanticReturnsStatsFromSamePass(t *testing.T) {
	raw := []byte(`{"schema_version":"renderinggen.overlay-plan.v1","plan_id":"p","video_id":"v","width":1280,"height":720,"fps_num":30,"fps_den":1,
      "items":[
        {"id":"e","entity_id":"entity:ada","kind":"entity_card","template_id":"PERSON","preset_id":"phrase_default","text":"Ada","start_ms":0,"end_ms":1000,"duration_ms":1000},
        {"id":"p","kind":"important_phrase","template_id":"IMPORTANT_PHRASE","preset_id":"phrase_default","text":"hi","start_ms":1000,"end_ms":2000},
        {"id":"w","kind":"important_word","template_id":"IMPORTANT_WORD","preset_id":"phrase_default","text":"WOW","start_ms":2000,"end_ms":3000},
...
func TestEntityCardWithImageLowersToOneImageLayer(t *testing.T) {
	raw := []byte(`{"schema_version":"renderinggen.overlay-plan.v1","plan_id":"p","video_id":"v","width":1280,"height":720,"fps_num":30,"fps_den":1,
      "items":[{"id":"jordan-42","entity_id":"person:michael-jordan","kind":"entity_card","template_id":"PERSON","preset_id":"phrase_default","image_preset_id":"image_focus_in","text":"Michael Jordan","start_ms":0,"end_ms":1000,"duration_ms":1000,
