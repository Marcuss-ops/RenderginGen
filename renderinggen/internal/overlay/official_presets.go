...
var officialPresets = map[string]OfficialPresetDefinition{
	...
	"name_glow_typewriter": makePreset("name_glow_typewriter", textSpec("lower_third", "left", "fade_in", "glyph", 10, 6, glowStyle())),
	...
	"phrase_word_reveal":   makePreset("phrase_word_reveal", textSpec("safe_area", "center", "fade_in", "word", 10, 6, nil)),
	...
	"active_word_pop":      makePreset("active_word_pop", textSpec("safe_area", "center", "fade_in", "word", 8, 6, nil)),
