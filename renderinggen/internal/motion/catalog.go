...
func init() {
	for _, d := range []MotionDefinition{
		...
		phraseAdvancedDefinition("dynamic_island_expansion", "line", "scale", []AnimationKeyframe{{0, 0.82}, {28, 1.04}, {72, 1.0}}, 0,
			[]TrackDefinition{phraseLayer("scale", 0.38, 1.12, 1.0)}),
		phraseAdvancedDefinition("masked_upward_reveal", "line", "position_y", []AnimationKeyframe{{0, 120.0}, {22, 0.0}}, 0,
			[]TrackDefinition{phraseLayer("position_y", 260.0, 18.0, 0.0), phraseLayer("rotation_z", 9.0, -1.0, 0.0)}),
		phraseAdvancedDefinition("staggered_char_float", "glyph", "position_y", []AnimationKeyframe{{0, 26.0}, {72, 0.0}}, 2,
			[]TrackDefinition{phraseLayer("position_y", 110.0, -10.0, 0.0), phraseLayer("scale", 0.72, 1.08, 1.0), phraseLayer("rotation_z", -12.0, 3.0, 0.0)}),
		phraseAdvancedDefinition("high_specular_light_sweep", "glyph", "tracking", []AnimationKeyframe{{0, 18.0}, {34, -2.0}, {72, 3.0}}, 1,
			[]TrackDefinition{phraseLayer("position_x", -420.0, 140.0, 0.0), phraseLayer("scale", 1.18, 0.96, 1.0)}),
		phraseAdvancedDefinition("depth_of_field_rack_focus", "glyph", "blur", []AnimationKeyframe{{0, 24.0}, {72, 0.0}}, 0,
			[]TrackDefinition{phraseLayer("scale", 1.28, 1.04, 1.0), phraseLayer("position_y", 26.0, -7.0, 0.0), phraseLayer("opacity", 0.12, 0.72, 1.0)}),
		phraseAdvancedDefinition("micro_tracker_kerning_compression", "glyph", "tracking", []AnimationKeyframe{{0, 28.0}, {72, -2.0}}, 0,
			[]TrackDefinition{phraseLayer("scale", 0.42, 1.10, 1.0), phraseLayer("position_x", 70.0, -10.0, 0.0)}),
		phraseAdvancedDefinition("isometric_3d_fold", "glyph", "position_y", []AnimationKeyframe{{0, 90.0}, {25, -4.0}, {72, 0.0}}, 1,
			[]TrackDefinition{phraseLayer("rotation_z", -28.0, 8.0, 0.0), phraseLayer("position_y", 180.0, -18.0, 0.0), phraseLayer("scale", 0.82, 1.03, 1.0)}),
		phraseAdvancedDefinition("soft_edge_spotlight_dissolve", "glyph", "opacity", []AnimationKeyframe{{0, 0.0}, {24, 1.0}}, 1,
			[]TrackDefinition{phraseLayer("scale", 1.34, 1.04, 1.0), phraseLayer("opacity", 0.0, 0.45, 1.0)}),
		phraseAdvancedDefinition("chromatic_aberration_pop", "glyph", "position_x", []AnimationKeyframe{{0, -12.0}, {12, 8.0}, {28, 0.0}}, 1,
			[]TrackDefinition{phraseLayer("position_x", -180.0, 34.0, 0.0), phraseLayer("rotation_z", -5.0, 2.0, 0.0), phraseLayer("scale", 0.70, 1.10, 1.0)}),
		phraseAdvancedDefinition("fluid_gradient_text_flow", "glyph", "tracking", []AnimationKeyframe{{0, -5.0}, {36, 6.0}, {72, -1.0}}, 1,
			[]TrackDefinition{phraseLayer("position_x", -260.0, 260.0, 0.0), phraseLayer("scale", 0.92, 1.08, 1.0)}),
		phraseAdvancedDefinition("velocity_inertia_snap", "line", "position_x", []AnimationKeyframe{{0, 620.0}, {42, -10.0}, {58, 3.0}, {72, 0.0}}, 0,
			[]TrackDefinition{phraseLayer("position_x", 760.0, -22.0, 8.0, 0.0), phraseLayer("rotation_z", 18.0, -4.0, 1.0, 0.0)}),
		phraseAdvancedDefinition("vertical_rolling_counter", "glyph", "position_y", []AnimationKeyframe{{0, 80.0}, {48, -8.0}, {72, 0.0}}, 1,
			[]TrackDefinition{phraseLayer("position_y", 360.0, -24.0, 0.0), phraseLayer("rotation_z", 20.0, -6.0, 0.0)}),
		phraseAdvancedDefinition("glassmorphism_card_tilt", "glyph", "scale", []AnimationKeyframe{{0, 0.92}, {24, 1.02}, {72, 1.0}}, 1,
			[]TrackDefinition{phraseLayer("rotation_z", -16.0, 8.0, 0.0), phraseLayer("position_x", -70.0, 34.0, 0.0), phraseLayer("scale", 0.90, 1.04, 1.0)}),
		phraseAdvancedDefinition("pixel_grid_alpha_matrix", "glyph", "blur", []AnimationKeyframe{{0, 18.0}, {28, 3.0}, {72, 0.0}}, 1,
			[]TrackDefinition{phraseLayer("scale", 0.34, 1.18, 1.0), phraseLayer("position_y", 34.0, -4.0, 0.0), phraseLayer("opacity", 0.0, 0.55, 1.0)}),
		...
		_ = Registry.Register(d.ID, DeclarativePlugin{Definition: d})
	}
}
...
// phraseLayer builds one composition-level track for a phrase preset:
// keyframes are spaced 24 frames apart with the last pinned at frame 72.
